...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a2ete4rtxizm3m.iot.eu-west-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "rpi_big_project" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME              "rPiProjectAntonis" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "ca.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "f93f6336c8-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "f93f6336c8-private.pem.key" ///< Device private key filename
// =================================================
